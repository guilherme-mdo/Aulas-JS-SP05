...
meuH3.innerHTML = "Esse texto foi inserido com JavaScript";
...
const elemento2 = document.getElementsByClassName('ex2');
...
// Pegando todos os elementos que possuem o mesmo seletor querySelectorAll()
